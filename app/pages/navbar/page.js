            ...
            <div className="container mx-auto  md:flex md:justify-between md:items-center">
                ...
                <div className={`md:flex items-center ${isOpen ? 'block' : 'hidden'}`}>
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-normal text-lg leading-5  rounded-lg  md:flex-row md:space-x-8 md:mt-0 gap-12 text-white">
                        ...
                        <li><Link href="/" className="hover:text-blue-500">Swap</Link></li>
                        <li><Link href="/" className="hover:text-blue-500">Stacking</Link></li>
                        <li><Link href="/" className="hover:text-blue-500">Pools</Link></li>
                        <li><Link href="/" className="hover:text-blue-500">NFT Market</Link></li>
                    </ul>
                </div>
                <div className={`md:flex items-center gap-3 ${isOpen ? 'block' : 'hidden'}`}>
                <li><Link href="/" className="hover:text-blue-500 text-white">Sign In</Link></li>
